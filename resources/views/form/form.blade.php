    ...
    <section id="form-section">
        ...
        @endif
            ...
            <div class="input-group mb-3 w-100 p-1">
               ...
               <textarea id="description" name="description" id="description" cols="50" rows="3" placeholder="Inserisci una descrizione..." class="w-100 @error('description') is-invalid @elseif(old('description')) is-valid @enderror">{{old('title', $comic->description)}}</textarea>
            </div>

            <div class="input-group mb-3 w-50 p-1">
                <label class="form-label label" for="thumb">Copertina</label>
                <input id="thumb" type="url"  name="thumb" class="form-control  @error('thumb') is-invalid @elseif(old('thumb')) is-valid @enderror" value="{{old('thumb', $comic->thumb)}}" placeholder="Inserisci url copertina...">
                @error('thumb')
                <div class="invalid-feedback">
                    Campo errato
                </div>   
            ...
            <div class="input-group mb-3 w-50 p-1">
                <label class="form-label label" for="price">Prezzo</label>
            ...
            <div class="input-group mb-3 w-50 p-1">
                <label class="form-label label" for="series">Serie</label>
            ...
            <div class="input-group mb-3 w-50 p-1">
                <label class="form-label label" for="type">Tipo</label>
            ...
            <div class="input-group mb-3 p-1">
                <label class="form-label label" for="artists">Artisti</label>
            ...
            <div class="input-group mb-3 p-1">
                <label class="form-label label" for="writers">Scrittori</label>
